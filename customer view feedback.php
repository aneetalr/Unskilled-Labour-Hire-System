...
<br>
<h2 align="center"><b>SUPERVISOR FEEDBACK</b></h2>
<br>
<table width="1200" height="150" border="1.5" align="center" class="customers">
   ...
   <th>Feeback</th></tr>
	<?php
    $supid=$_REQUEST['id'];
	$qw="select customer.*,feedback.* from customer inner join feedback on feedback.cid=customer.cid where  feedback.sid='$supid'";
